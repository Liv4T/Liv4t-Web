...
var render = function() {
  ...
  return _c("div", [
    _vm.current_module.id
      ? _c(
          "div",
          [
            _c("teacher-student-class-select", {
              attrs: {
                id_module: _vm.current_module.id,
                id_area: _vm.id_area,
      ...
      : _vm._e(),
    _vm._v(" "),
    _c("div", { staticClass: "col-12 col-md-12", attrs: { else: "" } }, [
      _c(
        "div",
        {
          directives: [
            {
              name: "show",
              rawName: "v-show",
              value: _vm.hideSection === false,
              expression: "hideSection === false"
            }
          ]
        },
        [
