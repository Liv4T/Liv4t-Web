  ...
  return _c("div", { staticClass: "div-classes" }, [
    _c(
      ...
      [
        ...
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-12" }, [
            _c("b", [_vm._v(_vm._s(_vm.$t("lang.general.description")) + ":")]),
            _vm._v(" "),
            _c("textarea", {
              directives: [
                {
        ...
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-12" }, [
            _c("b", [_vm._v(_vm._s(_vm.$t("lang.general.resources")) + ":")])
          ])
        ]),
        _vm._v(" "),
        _c(
                      ...
                      [
                        item_content.content_type === "DOCUMENT"
                          ? _c("h4", { staticStyle: { color: "#f79d52" } }, [
                              _vm._v(
                                "\n                        " +
                                  _vm._s(_vm.$t("lang.general.document")) +
                                  "\n                    "
                              )
                            ])
                              ...
                              ? _c(
                                  ...
                                  [
                                    _vm._v(
                                      "\n                                " +
                                        _vm._s(
                                          _vm.$t("lang.general.readDocument")
                                        ) +
                                        "\n                            "
                                    )
                                  ]
                              ...
                              ? _c(
                                  ...
                                  [
                                    _vm._v(
                                      "\n                                " +
                                        _vm._s(
                                          _vm.$t("lang.general.letsGoToWork")
                                        ) +
                                        "\n                            "
                                    )
                                  ]
                        ...
                        [
                          _c("div", { staticClass: "row" }, [
                            _c("div", { staticClass: "col-12" }, [
                              _c("b", [
                                _vm._v(
                                  _vm._s(_vm.$t("lang.general.description")) +
                                    ":"
                                )
                              ]),
                              _vm._v(" "),
    ...
    _c(
      ...
      [_vm._v(_vm._s(_vm.$t("lang.table.back_to")))]
    )
  ])
}
var staticRenderFns = []
