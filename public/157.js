...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    membersChat: function membersChat(title) {
      var _this2 = this;
      ...
      axios.get('/getChatAsigment').then(function (response) {
        ...
        members.forEach(function (stament) {
          if (stament.stament === title) {
            _this2.members.push(stament);
          }
        });
      });
...
var render = function() {
  ...
  return _c(
    ...
    [
                        ...
                        _c("th", [
                          ...
                          _c(
                            "button",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.membersChat(stament.stament)
                                }
                              }
                            },
                            [_vm._v("Miembros del Chat")]
                          )
                        ])
                      ])
                    ])
      ...
      _vm._v(" "),
      _c("members-chat", { attrs: { chat: _vm.chat, members: _vm.members } })
    ],
    1
  )
}
