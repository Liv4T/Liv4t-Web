                        ...
                        <table class="table table-responsive-xl table-hover table-striped center">
                            <tbody>
                                ...
                                <tr v-for="(cycle,k) in filteredRows" :key="k">
                                    <td>{{ cycle.order_items }} {{ cycle.driving_question }}</td>
...
<div v-else-if="showCycle==='courseSemanal'">
    <semanal-component :id_area="id_area" :id_classroom="id_classroom" :id_trimestre="idTrimestre" :orden="orden" :lengthCycles="lengthCycles" :cleanClasId="cleanIdModule"></semanal-component>
</div>
</template>
<script>
export default {
    ...
    methods: {
        ...
        getCycles(id_trimestre) {
            ...
            axios.get(url).then((response) => {
                ...
                this.lengthCycles = response.data.length;
